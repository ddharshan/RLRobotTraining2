...
The repository RLAutonomousRobotNavigation2
(https://github.com/ddharshan/RLAutonomousRobotNavigation2)
contains the simulation environment, including the robot model, pedestrian models, and the goal representation.

The repository RLRobotTraining2
(https://github.com/ddharshan/RLRobotTraining2)
contains the Deep Neural Network architecture used to train the robot within this environment.
